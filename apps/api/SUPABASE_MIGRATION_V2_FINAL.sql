...
ALTER PUBLICATION supabase_realtime ADD TABLE directfeedback;
ALTER PUBLICATION supabase_realtime ADD TABLE academy_lessons;
ALTER PUBLICATION supabase_realtime ADD TABLE practice_progress;
ALTER PUBLICATION supabase_realtime ADD TABLE user_academy_progress;
